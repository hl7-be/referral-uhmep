...
| Glycemia measurement timing | - Fasting<br>- Before insulin administration<br>- Before medication administration<br>- Daily glycemic profile | Enum |  |
  ...
  "requester": {
    "reference": "PractitionerRole/72101230445-PHYSICIAN"
      ...
      <td></td>
        ...
        <tr>
      <td>Glycemia measurement timing</td>
  ...
  "orderDetail": [
    {
      "coding": [
        {
          "system": "https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-glycemia-measurement-timing",
      ...
      <td><ul><li>system: <a href="https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-glycemia-measurement-timing"><code>https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-glycemia-measurement-timing</code></a></li><li>code: <code>before-insulin-administration</code></li><li>binding: <a href="https://www.ehealth.fgov.be/standards/fhir/terminology/ValueSet/be-vs-glycemia-measurement-time"><code>be-vs-glycemia-measurement-time</code></a></li></ul></td>
    </tr>
        <tr>
      <td>Diagnosis</td>
