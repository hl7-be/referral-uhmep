...
| Care type | - Medication administration<br>- Respiratory care<br>- Gastrointestinal care<br>- Urogenital care<br>- Catheter care<br>- Wound care<br>- Compression therapy<br>- Other | List |  |
| This field appears when "Care type" = "Other" |  |  |  |
...
| Medical reason | ... | String | Medical reason; coded value when available, otherwise pseudonymized text. |
  ...
  "orderDetail": [
    {
      "coding": [
        {
          "system": "https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-generic-care-types",
          "code": "preparation-and-administration-of-medication-for-psychiatric-patient"
        }
      ]
    }
  ]
}</code></pre></td>
      <td><ul><li>system: <a href="https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-generic-care-types"><code>https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-generic-care-types</code></a></li><li>code: <code>preparation-and-administration-of-medication-for-psychiatric-patient</code></li></ul></td>
    </tr>
        <tr>
      <td>This field appears when "Care type" = "Other"</td>
      <td><code>ServiceRequest.orderDetail</code></td>
      <td><pre><code class="language-json">{
  "orderDetail": [
    {
  ...
  "reasonCode": [
    {
      ...
      <td><ul><li>system: <a href="http://snomed.info/sct"><code>http://snomed.info/sct</code></a></li><li>code: <code>404684003</code></li></ul></td>
    </tr>
        <tr>
      <td>Frequency</td>
