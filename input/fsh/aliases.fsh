...
//Alias: $be-nursing-medication-percutaneous = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-nursing-medication-percutaneous
//Alias: $be-nursing-medication-injection = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-nursing-medication-injection
Alias: $jurisdiction = urn:iso:std:iso:3166
Alias: $v3-NullFlavor = http://terminology.hl7.org/CodeSystem/v3-NullFlavor
Alias: $DCM = http://dicom.nema.org/resources/ontology/DCM
Alias: $task-status = http://hl7.org/fhir/task-status
//Alias: $temp-service = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-cs-temp-requested-service
//Alias: $be-cs-nursing-code-compressiontherapy = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-cs-nursing-code-compressiontherapy
Alias: $be-cs-digestive-system-care = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-cs-digestive-system-care
//Alias: $be-nursing-annex81-inadequate-adherence = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-nursing-annex81-inadequate-adherence
//Alias: $be-nursing-annex81-inadequate-adherence-link = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-nursing-annex81-inadequate-adherence-link
//Alias: $be-cs-type-of-bladder-care = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-cs-type-of-bladder-care
//Alias: $be-cs-nursing-code-non-reimbursable = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-cs-nursing-code-non-reimbursable
...
Alias: $BeDRPCodeableConcept = https://www.ehealth.fgov.be/standards/fhir/drp/StructureDefinition/be-ext-codeable-concept
Alias: $be-ext-laterality = https://www.ehealth.fgov.be/standards/fhir/core-clinical/StructureDefinition/be-ext-laterality
Alias: $be-ext-body-topography = https://www.ehealth.fgov.be/standards/fhir/core-clinical/StructureDefinition/be-ext-body-topography
...
Alias: $be-ext-pseudonymized-content = https://www.ehealth.fgov.be/standards/fhir/infsec/StructureDefinition/be-ext-pseudonymized-content
